...
PICS = (environ.get('PICS', 'https://i.ibb.co/jvkRpVVB/photo-2026-04-17-09-49-02-7629665657931431952.jpg https://i.ibb.co/VYYw0nqy/photo-2026-04-17-09-50-27-7629665709471039508.jpg')).split()  # Sample pic
NOR_IMG = environ.get("NOR_IMG", "https://i.ibb.co/jvkRpVVB/photo-2026-04-17-09-49-02-7629665657931431952.jpg")
MELCOW_VID = environ.get("MELCOW_VID", "https://i.ibb.co/jvkRpVVB/photo-2026-04-17-09-49-02-7629665657931431952.jpg")
SPELL_IMG = environ.get("SPELL_IMG", "https://i.ibb.co/jvkRpVVB/photo-2026-04-17-09-49-02-7629665657931431952.jpg")
SUBSCRIPTION = (environ.get('SUBSCRIPTION', 'https://i.ibb.co/jvkRpVVB/photo-2026-04-17-09-49-02-7629665657931431952.jpg'))
FSUB_PICS = (environ.get('FSUB_PICS', 'https://i.ibb.co/jvkRpVVB/photo-2026-04-17-09-49-02-7629665657931431952.jpg')).split()  # Fsub pic

# ============================
# Admin, Channels & Users Configuration
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '8376881510').split()] # Replace with the actual admin ID(s) to add
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1003933077267').split()]  # Channel id for auto indexing (make sure bot is admin)
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1003949787884'))  # Log channel id (make sure bot is admin)
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1003949787884'))  # Bin channel id (make sure bot is admin)
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1003960944576'))  # Notification of those who verify will be sent to your channel
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1003949787884'))  # Premium logs channel id
auth_channel = environ.get('AUTH_CHANNEL', '-1003930642871')  # Channel/Group ID for force sub (make sure bot is admin)
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '').split()]
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1003856324938')  # Support group id (make sure bot is admin)
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1003530415557')  # Request channel id (make sure bot is admin)
AUTH_CHANNEL = [int(fch) if id_pattern.search(fch) else fch for fch in environ.get('AUTH_CHANNEL', '-1003930642871').split()]
MULTI_FSUB = [int(channel_id) for channel_id in environ.get('MULTI_FSUB', '-1003930642871').split() if re.match(r'^-?\d+$', channel_id)]  # Channel for force sub (make sure bot is admin)
...
#Auto approve 
CHAT_ID = [int(app_chat_id) if id_pattern.search(app_chat_id) else app_chat_id for app_chat_id in environ.get('CHAT_ID', '-1003856324938').split()]
TEXT = environ.get("APPROVED_WELCOME_TEXT", "<b>{mention},\n\nʏᴏᴜʀ ʀᴇǫᴜᴇsᴛ ᴛᴏ ᴊᴏɪɴ {title} ɪs ᴀᴘᴘʀᴏᴠᴇᴅ.\n\‣ ᴘᴏᴡᴇʀᴇᴅ ʙʏ @InfinixSyndicate</b>")
...
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://hacker_G:fgE9tgSbmCdAjS48@cluster2.80xswem.mongodb.net/?appName=Cluster2")
...
VERIFIED_LOG = int(environ.get('VERIFIED_LOG', '-1003949787884'))  # Log channel id (make sure bot is admin)
HOW_TO_VERIFY = environ.get('HOW_TO_VERIFY', 'https://t.me/Infinix_Tutorial/14')  # How to open tutorial link for verification
...
SHORTLINK_API = environ.get('SHORTLINK_API', '573350da0e10a5a44f7e6fec3bc2b3f836b47805')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/Infinix_Tutorial/14')  # Tutorial video link for opening shortlink website
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))

# ============================
# Channel & Group Links Configuration
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/VeloraFilms')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/VeloraFilms')
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/Im_Sukuna02')
MOVIE_UPDATE_CHANNEL_LNK = environ.get('MOVIE_UPDATE_CHANNEL_LNK', 'https://t.me/VeloraFilms')
OWNERID = int(os.environ.get('OWNERID', '8376881510'))  # Replace with the actual admin ID
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/im_sukuna02')  # Support group link (make sure bot is admin)
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1003933077267')).split()]
