...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1003903442288')  # Support group id (make sure bot is admin)
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/Infinix_Support')  # Support group link (make sure bot is admin)
